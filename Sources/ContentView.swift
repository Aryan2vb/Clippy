...
struct FileRowView: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            // File thumbnail/icon with preview support (click to QuickLook)
                ...
                HStack(spacing: 6) {
                    ...
                    if !file.isDirectory && !file.fileExtension.isEmpty {
                        Text(file.fileExtension.uppercased())
                            ...
                            .foregroundColor(fileTypeBadgeColor)
                            .cornerRadius(3)
                    }
            ...
            if isHovering && !file.isDirectory {
                Button {
    ...
    /// Returns a color for the file type badge based on extension
